...
if (isset($_POST['CCSubmit'])){
  ...
  if ($tNum == '566243'){
    if($ad == 'aaShipper'){
      ...
      if (empty($load) || empty($date) || empty($arrival) || empty($atrailer) || empty($seal) || empty($last) || empty($mileage)){
          header("Location: ../EP/checkCall.php?error=emptyfields&load=".$load."&date=".$date."&arrival=" .$arrival. "&atrailer=" .$atrailer. "&seal=" .$seal. "&last=" .$last. "&mileage" .$mileage);
          exit();
      }
      else {
        ...
        if($row["departureTrailer"] != '0'){
          ...
          /* Set the subject. */
          $mail->Subject = "Arrive at Shipper Check Call for Truck 566243";

          /* Set the mail message body. */
          $mail->isHTML(TRUE);
          $mail->Body = "<html>
                  <head>
                  <title>Arrival Check Call</title>
                  </head>
                  <body>
                  <p>This is the Arrival at Shipper Check Call information for 566243</p>
                  <table>
                  <tr>
                  <th>Load Number:</th>
                  <th>Truck Number:</th>
          ...
          echo 'You must have a departure call before you can enter a new arrival call.';
    ...
    elseif($ad == 'aaConsignee'){
      ...
      if (empty($load) || empty($date) || empty($arrival) || empty($atrailer) || empty($seal) || empty($last) || empty($mileage)){
        ...
        if($row["departureTrailer"] != '0'){
          ...
          /* Set the subject. */
          $mail->Subject = "Arrive at Consignee Check Call for Truck 566243";
          ...
          $mail->Body = "<html>
                  ...
                  <body>
                  <p>This is the Arrival at Consignee Check Call information for 566243</p>
                  <table>
                  <tr>
                  <th>Load Number:</th>
                  <th>Truck Number:</th>
...
elseif($tNum == '566521'){
      ...
      if (empty($load) || empty($date) || empty($arrival) || empty($atrailer) || empty($seal) || empty($last) || empty($mileage)){
        ...
        if($row["departureTrailer"] != '0'){
          ...
          /* Set the subject. */
          $mail->Subject = "Arrive at Shipper Check Call for Truck 566521";
          ...
          $mail->Body = "<html>
                  ...
                  <body>
                  <p>This is the Arrival at Shipper Check Call information for 566521</p>
                  <table>
                  <tr>
                  <th>Load Number:</th>
                  <th>Truck Number:</th>
    ...
    elseif($ad == 'aaConsignee'){
      ...
      if($row["departureTrailer"] != '0'){
        ...
        /* Set the subject. */
        $mail->Subject = "Arrive at Consignee Check Call for Truck 566521";
        ...
        $mail->Body = "<html>
                ...
                <body>
                <p>This is the Arrival at Consignee Check Call information for 566521</p>
                <table>
                <tr>
                <th>Load Number:</th>
                <th>Truck Number:</th>
  ...
  if($ad == 'aaShipper'){
    ...
    if (empty($load) || empty($date) || empty($arrival) || empty($atrailer) || empty($seal) || empty($last) || empty($mileage)){
      ...
      if($row["departureTrailer"] != '0'){
        ...
        /* Set the subject. */
        $mail->Subject = "Arrive at Shipper Check Call for Truck 567130";
        ...
        $mail->Body = "<html>
              ...
              <body>
              <p>This is the Arrival at Shipper Check Call information for 567130</p>
              <table>
              <tr>
              <th>Load Number:</th>
              <th>Truck Number:</th>
  ...
  elseif($ad == 'aaConsignee'){
    ...
    if (empty($load) || empty($date) || empty($arrival) || empty($atrailer) || empty($seal) || empty($last) || empty($mileage)){
      ...
      if($row["departureTrailer"] != '0'){
        ...
        /* Set the subject. */
        $mail->Subject = "Arrive at Consignee Check Call for Truck 567130";
        ...
        $mail->Body = "<html>
                ...
                <body>
                <p>This is the Arrival at Consignee Check Call information for 567130</p>
                <table>
                <tr>
                <th>Load Number:</th>
                <th>Truck Number:</th>
